...
public class Execution_Result_Initiate {
...
File xlsxFile = new File(xlfilepath);
        ...
        try {
            ...
            sheet.getRow(BIPS_Initiate.row).getCell(BIPS_Initiate.cell_actual_result).setCellValue("As expected");

            sheet.getRow(BIPS_Initiate.row).getCell(BIPS_Initiate.cell_Status).setCellValue("Pass");
            
//          sheet.getRow(BIPS_Initiate.row).getCell(BIPS_Initiate.cell_Status).setCellValue("");
            //Close input stream
            inputStream.close();
	...
	public static void Fill_Fail_Result() throws Exception {
		...
		File xlsxFile = new File(xlfilepath);        
		        try {
		            ...
		            //Reading first sheet of excel file
		            Sheet sheet = workbook.getSheetAt(1);
		            sheet.getRow(BIPS_Initiate.row).getCell(BIPS_Initiate.cell_actual_result).setCellValue(""); 
		            sheet.getRow(BIPS_Initiate.row).getCell(BIPS_Initiate.cell_actual_result).setCellValue(BIPS_Initiate.nameofCurrMethod);
		            sheet.getRow(BIPS_Initiate.row).getCell(BIPS_Initiate.cell_Status).setCellValue("Fail");
		            //Close input stream
		            inputStream.close();
	...
	public static void Update_GLDT_CaseId() throws Exception {
		...
		File xlsxFile = new File(xlfilepath);        
		        try {
		            ...
		            sheet.getRow(BIPS_Initiate.row).getCell(BIPS_Initiate.cell_case_id).setCellValue(BIPS_Initiate.Case_Id);           
		            //Close input stream
		            inputStream.close();
