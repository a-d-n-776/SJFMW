...
//				public static String getDateAsString1() {
//					DateFormat dateFormat = new SimpleDateFormat("HH:mm:ss");
//					Date date = new Date();
...
//				}
				for (ITestResult testResult : tests.getResults(method)) {
					...
					if (testResult.getStartMillis() < start) {
						...
						Date date = new Date();
						DateFormat dateFormat = new SimpleDateFormat("HH:mm:ss");
						Execution_Start_Time = dateFormat.format(date);
					}
...
//						String str = Utils.StackTrace(exception, true)[0];
						String str = Utils.longStackTrace(exception, hasThrowable);
				...
				buff.append("<td><a href=\"#m"
                        ...
                        + "<td>" + Execution_Start_Time + "</td>" + "<td class=\"numi\">"
                        + (end - start) + "</td>" + "</tr>");
			}
			if (mq > 0) {
				cq += 1;
