...
public class GLDT_TC_2 {
	...
	//Select Temporary produtcs check box.Initiate a GLDT case.
		...
		//WebElement Arrow = driver.findElement(By.xpath("//label[@for='e2457cfb']"));
		//Arrow.submit();
		
		//driver.findElement(By.xpath("//button[contains(@class,'rotate-down')]//i[contains(@class,'pi pi-caret-down')]"));
		//Thread.sleep(5000);
